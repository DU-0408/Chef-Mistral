 ...
 * Handles OAuth callback tokens from URL params.
...
import { login as loginApi, getGoogleAuthUrl, getMe } from "@/lib/api";
...
function LoginForm() {
  ...
  // Handle Google OAuth callback (token comes as URL param)
  useEffect(() => {
      ...
      <div className="auth-container">
        <div className="auth-card">
          <div className="auth-header">
            <h2>Welcome back</h2>
            <p>Sign in to your Chef Qwen account</p>
          </div>
